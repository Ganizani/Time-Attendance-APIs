...
class CreateAccessControlTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('access_control', function (Blueprint $table) {
            ...
            //REPORTS
            $table->integer('add_report')->nullable(true)->default(0);
            $table->integer('edit_report')->nullable(true)->default(0);
            $table->integer('list_report')->nullable(true)->default(0);
            $table->integer('print_report')->nullable(true)->default(0);
            //DEPARTMENTS
            ...
            //LEAVE TYPES
            $table->integer('add_leave_type')->nullable(true)->default(0);
            $table->integer('edit_leave_type')->nullable(true)->default(0);
            $table->integer('list_leave_type')->nullable(true)->default(0);
            $table->integer('print_leave_type')->nullable(true)->default(0);
            //HOLIDAYS
